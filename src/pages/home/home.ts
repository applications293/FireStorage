 ...
 */
  ...
  var config = {
    apiKey: "AIzaSyAw7V-568IIdsl53TwqBqBVhAkxjVsCm-A",
    authDomain: "firestorage-d99dd.firebaseapp.com",
    databaseURL: "https://firestorage-d99dd.firebaseio.com",
    projectId: "firestorage-d99dd",
    storageBucket: "firestorage-d99dd.appspot.com",
    messagingSenderId: "608350852710"
  };
...
export class HomePage {
  ...
  constructor(public zone: NgZone, public navCtrl: NavController, public navParams: NavParams,private mediaCapture: MediaCapture, private platform: Platform, private file: File) {
    ...
    this.platform.ready().then(() => {
      ...
      promise.then((mediaFile: MediaFile[]) => {
       ...
       // this.presentLoading();
        ...
        return this.file.readAsArrayBuffer(directory, name).then((buffer: ArrayBuffer) => {
          console.log(buffer)
